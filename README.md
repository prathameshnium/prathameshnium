...
| --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| [**PICA: Python Instrument Control & Automation**](#)                   | A comprehensive suite of scripts using `PyVISA` to control and automate laboratory instruments for materials science research. (*This repo is private; please contact me for access.*) | `Python`, `PyVISA`, `PyMeasure`, `Pandas` |
