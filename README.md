...
<p align="center">
  ...
  <a href="https://scipy.org/" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/devicons/devicon/develop/icons/scipy/scipy-original.svg" alt="scipy" width="40" height="40"/> </a>
...
| --------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| **PICA: Python Instrument Control & Automation** | A suite of scripts using `PyVISA` to automate instruments including **Keithley** (2400, 2182A, 6221, 6517B), **Lakeshore** (340, 350), and **Keysight** (E4980A). *This repository is currently private due to academic restrictions, but feel free to contact me for details.* | `Python`, `PyVISA`, `PyMeasure`, `NumPy`, `Pandas` |
